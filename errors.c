...
void stack_empty(int line_number)
{
	write(STDERR_FILENO, "L", 1);
	print_int(line_number);
	write(STDERR_FILENO, ": can't pint, stack empty", 24);
	write(STDERR_FILENO, "\n", 1);
	exit(EXIT_FAILURE);
}
...
void stack_emptypop(int line_number)
{
	write(STDERR_FILENO, "L", 1);
	print_int(line_number);
	write(STDERR_FILENO, ": can't pop an empty stack", 26);
	write(STDERR_FILENO, "\n", 1);
	exit(EXIT_FAILURE);
}
...
void lesstwoelements(int line_number)
{
	write(STDERR_FILENO, "L", 1);
	print_int(line_number);
	write(STDERR_FILENO, ": can't add, stack too short", 27);
	write(STDERR_FILENO, "\n", 1);
	exit(EXIT_FAILURE);
}
...
void lesstwoelementsswap(int line_number)
{
	write(STDERR_FILENO, "L", 1);
	print_int(line_number);
	write(STDERR_FILENO, ": can't swap, stack too short", 28);
	write(STDERR_FILENO, "\n", 1);
	exit(EXIT_FAILURE);
}